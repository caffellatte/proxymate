import { Button, ScrollArea, Typography } from "@/shared/ui";
import { uiActor, logsActor } from "@/xstate";
import { XCircle, Trash2 } from "lucide-react";
import { useSelector } from "@xstate/react";
import debug from "debug";
import { LogsRecord } from "@/main/components/templates";
import { useEffect } from "react";
import { ILogsRecord } from "@/interfaces";
const logger = debug("main:ProxyLog");
          ...
          <div className="flex flex-col gap-2">
            {Object.keys(logActorState.context.log).map((connectionId) => {
              ...
              return (
                <LogsRecord
                  key={connectionId}
                  log={logRecord as Omit<ILogsRecord, "proxyId">}
                />
              );
            })}
          </div>
